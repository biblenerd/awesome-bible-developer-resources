...
- [Society of Biblical Literature (SBL) Greek NT (SBLGNT)](https://sblgnt.com) [![License: CC BY 4.0](https://licensebuttons.net/l/by/4.0/80x15.png)](https://creativecommons.org/licenses/by/4.0/) &mdash; A freely-available critically edited Greek New Testament encoded in a Unicode-compliant font. Made available by [Logos Bible Software](https://www.logos.com/product/8486/the-greek-new-testament-sbl-edition) ([also on GitHub](https://github.com/LogosBible/SBLGNT)) and the SBL in [a variety of formats](https://sblgnt.com/download/) including XML, [OSIS](#osis), [SWORD module](https://www.crosswire.org/sword/modules/ModInfo.jsp?modName=SBLGNT), plaintext, PDF, and more.
